...
module.exports.reviewsReadOne = function (req, res) {
    if(req.params && req.params.locationid && req.params.reviewid){
        //first find the main location document then find review subdocument
        Loc.findById(req.params.locationid).select('name reviews').exec(function(err, location){
            ...
            //Check that location has reviews
            if(location.reviews && location.reviews.length > 0) {
                //pass reviewid from parameters to id method
        ...
        sendJsonResponse(res, 404, {"messege" : "No locationid or/and reviewid in request"});
    }
};
